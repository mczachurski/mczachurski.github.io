...
export class NavElement extends LitElement {
    ...
    setColorScheme = (e: MediaQueryList | MediaQueryListEvent) => {
        if (e.matches) {
    ...
    @property({ type: String }) navbarCss = 'navbar-light';
    @property({
        type: Object, reflect: true, converter: {
            fromAttribute: (value, _type) => {
                ...
                const enumValue = Pages[value as keyof typeof Pages];
                return enumValue;
            },
            toAttribute: (value, _type) => {
                const stringValue = (value as Pages).toString();
                return stringValue;
            }
        }
